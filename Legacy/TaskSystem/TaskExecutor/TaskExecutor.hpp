...
#include "Legacy/TaskSystem/Task/Task.hpp"
#include <Legacy/TaskSystem/ParallelTask/TaskSplitters.hpp>
#include <Legacy/TaskSystem/ParallelTask/ParallelTask.hpp>
#include "Legacy/TaskSystem/WorkStealingQueue/WorkStealingQueue.hpp"
...
void TaskExecutor::ParallelForTask(TaskExecutor* te, Task* task, const void* taskData)
{
	...
	const typename TaskData::SplitterType& splitter = data->splitter;
