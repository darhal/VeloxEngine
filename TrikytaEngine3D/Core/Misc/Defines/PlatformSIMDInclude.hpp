...
#define SHUFFLE_PARAM(x, y, z, w) \
	...
	const int32 ALIGN(16) __MASKSIGNs_[4] = { (int32) 0x80000000, (int32) 0x80000000, (int32) 0x80000000, (int32) 0x80000000 };
	const int32 ALIGN(16) _Sign_PNPN[4]   =	{ (int32) 0x00000000, (int32) 0x80000000, (int32) 0x00000000, (int32) 0x80000000 };
	const int32 ALIGN(16) _Sign_NPNP[4]   = { (int32) 0x80000000, (int32) 0x00000000, (int32) 0x80000000, (int32) 0x00000000 };
	const int32 ALIGN(16) _Sign_PNNP[4]   = { (int32) 0x00000000, (int32) 0x80000000, (int32) 0x80000000, (int32) 0x00000000 };
	const int32 ALIGN(16) __0FFF_[4]      = { (int32) 0xFFFFFFFF, (int32) 0xFFFFFFFF, (int32) 0xFFFFFFFF, (int32) 0x00000000 };
	const float ALIGN(16) __ZERONE_[4]    = { 1.0f, 0.0f, 0.0f, 1.0f };
	const float ALIGN(16) __1000_[4]      = { 1.0f, 0.0f, 0.0f, 0.0f };
