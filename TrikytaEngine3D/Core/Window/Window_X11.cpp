...
void TRE::Window::EnableFullscreen(bool enabled, int width, int height)
{
	if (enabled)
	{
...
void TRE::Window::WindowEvent(const XEvent& event)
{
	Event ev;
...
Bool TRE::Window::CheckEvent(Display*, XEvent* event, XPointer userData)
{
	return event->xany.window == reinterpret_cast<::Window>(userData);
}

Key::key_t TRE::Window::TranslateKey(uint code)
{
